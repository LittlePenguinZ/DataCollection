...
public class DataAcq_lY_Adapter$ViewHolder_ViewBinding<T extends DataAcq_lY_Adapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public DataAcq_lY_Adapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
