...
public class DataAcqChooseActivity_ViewBinding<T extends DataAcqChooseActivity> implements Unbinder {
  protected T target;

  private View view2131427512;

  @UiThread
  public DataAcqChooseActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.allLL = Utils.findRequiredViewAsType(source, R.id.allLL, "field 'allLL'", LinearLayout.class);
  }
