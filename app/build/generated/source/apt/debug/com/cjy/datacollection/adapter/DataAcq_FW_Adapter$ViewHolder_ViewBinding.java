...
public class DataAcq_FW_Adapter$ViewHolder_ViewBinding<T extends DataAcq_FW_Adapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public DataAcq_FW_Adapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
