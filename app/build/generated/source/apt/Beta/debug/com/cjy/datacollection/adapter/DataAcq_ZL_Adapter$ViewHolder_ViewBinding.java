...
public class DataAcq_ZL_Adapter$ViewHolder_ViewBinding<T extends DataAcq_ZL_Adapter.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public DataAcq_ZL_Adapter$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
