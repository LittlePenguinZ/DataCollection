...
public class QiYeAcqRecordListAdatper$ViewHolder_ViewBinding<T extends QiYeAcqRecordListAdatper.ViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public QiYeAcqRecordListAdatper$ViewHolder_ViewBinding(T target, View source) {
    this.target = target;
