...
public class DataRecordActivity_ViewBinding<T extends DataRecordActivity> implements Unbinder {
  protected T target;

  private View view2131427512;

  @UiThread
  public DataRecordActivity_ViewBinding(final T target, View source) {
    this.target = target;
