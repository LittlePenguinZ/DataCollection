...
public class DataAcqRecordListActivity_ViewBinding<T extends DataAcqRecordListActivity> implements Unbinder {
  protected T target;

  private View view2131427512;

  @UiThread
  public DataAcqRecordListActivity_ViewBinding(final T target, View source) {
    this.target = target;
